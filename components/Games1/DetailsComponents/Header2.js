...
const Header2 = ({ item }) => {
    ...
    return (
        <View>
            ...
            <View style={{ width: '90%', justifyContent: 'space-around', flexDirection: 'row', alignSelf: 'center' }}>
                <Text style={{ fontSize: 16, fontWeight: 'bold', width: '42%', textAlign: 'center' }}>{item.competitions[0].competitors[0].team.displayName}</Text>
                <Text style={{ color: 'orange' }}>VS</Text>
                <Text style={{ fontSize: 16, fontWeight: 'bold', width: '42%', textAlign: 'center' }}>{item.competitions[0].competitors[1].team.displayName}</Text>
            </View>
